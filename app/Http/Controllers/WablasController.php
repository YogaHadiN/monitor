...
class WablasController extends Controller
{
    ...
    private function tanyaSiapaPetugasPemeriksa(ReservasiOnline $reservasi_online): string
    {
        ...
        $formatGigi = function (Collection $list): string
        {
            ...
            if ( $reservasi_online->tipe_konsultasi_id == 2 ) {
                $message .= 'Pengambilan antrian online harus scan QR CODE di klinik 15 menit sebelum jam mulai praktek ('
    ...
    private function tanyaSyaratdanKetentuan($reservasi_online): string
    {
        ...
        if ($tipe_id === 1) {
            ...
            if (!empty($jamMulaiGigiStr)) {
                ...
                $lines[] = "- Mohon melakukan *scan QR* di klinik *paling lambat pukul {$jamTerakhirQR}* (15 menit sebelum jam praktik dimulai).";
                $lines[] = '- Antrean akan *dibatalkan otomatis* bila terlambat melakukan scan.';
            } else {
