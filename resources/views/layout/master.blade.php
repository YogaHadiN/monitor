                ...
                <ul class="nav" id="side-menu">
					...
					<li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>{!! HTML::link('credentials', 'Credential')!!}</li>
                            <li>{!! HTML::link('complains', 'Komplain')!!}</li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>{!! HTML::link('surats', 'Surat Masuk')!!}</li>
                            <li>{!! HTML::link('surat_keluars', 'Surat Keluar')!!}</li>
                            <li>{!! HTML::link('documents', 'Dokumen Penting')!!}</li>
                            <li>{!! HTML::link('sertifikats', 'Sertifikat')!!}</li>
                            <li>{!! HTML::link('surat_keputusans', 'Surat Keputusan')!!}</li>
                            <li>{!! HTML::link('sops', 'Standard Operating Procedure')!!}</li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>{!! HTML::link('cek_list_mingguans', 'Cek List Mingguan')!!}</li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>{!! HTML::link('foto_prolanis', 'Foto Prolanis')!!}</li>
                            <li>{!! HTML::link('nomor_bpjs_tidak_valid', 'Nomor BPJS belum benar')!!}</li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Akreditasi</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>{!! HTML::link('kegiatans', 'Kegiatan')!!}</li>
                            <li>{!! HTML::link('ikps', 'IKP')!!}</li>
                            <li>{!! HTML::link('informed_concents', 'Informed Concent')!!}</li>
                            <li>{!! HTML::link('penilaian_kinerjas', 'Penilaian Kinerja')!!}</li>
                            <li>{!! HTML::link('asessment_pra_bedahs', 'Asessment Pra Bedah')!!}</li>
                            <li>{!! HTML::link('inms', 'INM')!!}</li>
                            <li>{!! HTML::link('laporan_pembedahans', 'Laporan Pembedahan')!!}</li>
                            <li>{!! HTML::link('laporan_wajib_bulanan', 'Laporan Wajib Bulanan')!!}</li>
                            <li>{!! HTML::link('bukti_pengukuran_mutu_layanan', 'Bukti Pengukuran Mutu')!!}</li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>{!! HTML::link('dispensings', 'Kartu Stok Obat')!!}</li>
                            <li>{!! HTML::link('obat/fast_moving', 'Obat Fast Moving')!!}</li>
                        </ul>
                    </li>
                     <li>
                        <a href="{{ url('mereks')}}"><i class="fa fa-flask"></i> <span class="nav-label">Formulir PDF</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>{!! HTML::link('pdfs/format_persetujuan_tindakan', 'Persetujuan Tindakan Medis')!!}</li>
                            <li>{!! HTML::link('pdfs/assemen_pra_anestesi', 'Penilaian Pra Anestesi')!!}</li>
                            <li>{!! HTML::link('pdfs/form_monitoring', 'Monitoring Pembedahan')!!}</li>
                            <li>{!! HTML::link('pdfs/format_penolakan_tindakan', 'Penolakan Tindakan Medis')!!}</li>
                            <li>{!! HTML::link('pdfs/rekam_medis', 'Penilaian Pra Bedah')!!}</li>
                            <li>{!! HTML::link('pdfs/surgical_safety', 'Surgical Safety Checklist')!!}</li>
                            <li>{!! HTML::link('pdfs/form_kosong/formulirAbsenProlanis', 'Absen Prolanis')!!}</li>
                            <li>{!! HTML::link('pdfs/form_kosong/formulirHakDanKewajibanPasien', 'Hak Dan Kewajiban Pasien')!!}</li>
                            <li>{!! HTML::link('pdfs/form_kosong/formulirCeklistKomunikasiEfektif', 'Ceklist Komunikasi Efektif')!!}</li>
                        </ul>
                    </li>
					@if(\Auth::id() == 28)
                     <li>
					...
					@endif
                     <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>{!! HTML::link('setor_pph21s', 'Setor Pph 21')!!}</li>
                            <li>{!! HTML::link('wablas_payments', 'Pembayaran Wablas')!!}</li>
					...
					@endif
                    <li>
                        <a href="{{ url('mereks')}}"><i class="fa fa-flask"></i> <span class="nav-label">Fasilitas Baru</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>{!! HTML::link('project/antrian_farmasi', 'antrian_farmasi')!!}</li>
                            <li>{!! HTML::link('project/antrian_dokter', 'antrian_dokter')!!}</li>
                            <li>{!! HTML::link('project/ambil_antrian', 'ambil_antrian')!!}</li>
                            <li>{!! HTML::link('project/uang', 'uang')!!}</li>
                            <li>{!! HTML::link('project/general_concent', 'general_concent')!!}</li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Dummy</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>{!! HTML::link('dummy/hak_dan_kewajiban_pasien', 'Hak dan Kewajiban')!!}</li>
                            <li>{!! HTML::link('dummy/informed_concent', 'Informed Concent')!!}</li>
                            <li>{!! HTML::link('dummy/asessment_pra_bedah', 'Asessment Pra Bedah')!!}</li>
                            <li>{!! HTML::link('dummy/laporan_pembedahan', 'Laporan Pembedahan')!!}</li>
                            <li>{!! HTML::link('dummy/asessment_awal', 'Asessment Awal')!!}</li>
                        </ul>
                    </li>
